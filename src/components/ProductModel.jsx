        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 md:pl-6 mt-4 md:mt-0">
            ...
            <div className="flex items-center mb-4">
              ...
              <p className="text-indigo-600 font-semibold text-xl ml-4">${product.selling_price.toFixed(2)}</p>
            </div>
            <p className="text-gray-700 mb-4">{product.description}</p>
            <button className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 transition-colors cursor-pointer">Add to Cart</button>
          </div>
        </div>
      </div>
    </div>
