...
const slidesData = [
    { id: 1, image: "/img/banner-1.jpg", title: "Welcome to Vendora", subtitle: "Your one-stop product-list for all your needs!", cta: "Explore Now", ctaLink: "/products" },
    { id: 2, image: "/img/sale.jpg", title: "Amazing Deals Daily", subtitle: "Don't miss out on our special offers.", cta: "product-list Deals", ctaLink: "/deals" },
    { id: 3, image: "/img/banner-2.jpg", title: "Discover Unique Products", subtitle: "Handpicked items just for you.", cta: "View Collection", ctaLink: "/collections/unique" },
    { id: 4, image: "/img/food-deli-1.jpg", title: "Fast Shipping", subtitle: "Get your products delivered in no time.", cta: "Learn More", ctaLink: "/shipping-info" },
    { id: 5, image: "/img/food-deli-2.jpg", title: "Every time on exact time", subtitle: "Get your products delivered in no time.", cta: "Learn More", ctaLink: "/shipping-info" },
];
