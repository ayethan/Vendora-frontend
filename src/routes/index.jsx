...
import FoodDeliveryHome from '../pages/Frontend/FoodDeliveryHome/FoodDeliveryHome'
...
import RestaurantList from '../pages/Admin/restaurants/Index'
import ProductFormModal from '../pages/Admin/products/ProductFormModal'
import Cuisine from '../pages/Admin/cuisines/Index'

import Restaurant from '../pages/Frontend/Restaurant/Index'
import RestaurantDetail from '../pages/Frontend/Restaurant/Detail'

import Page from '../pages/Admin/pages/Index'
                ...
                <Route element={<AdminLayout />}>
                    <Route element={<AdminRoute />}>
                        <Route path='/admin' element={<Dashboard />}>
                            ...
                            {/* <Route path='products' element element={<ProductList />} /> */}
                            <Route path='orders' element={<OrderList />} />
                            <Route path='category' element={<Category />} />
                            <Route path='shop-category' element={<ShopCategory />} />
                            <Route path='cuisines' element={<Cuisine />} />
                            <Route path='restaurants' element={<RestaurantList />} />
                            {/* New nested route for products of a specific restaurant */}
                            <Route path='restaurants/:restaurantId/products' element={<ProductList />} />
                            <Route path='restaurants/:restaurantId/products/create' element={<ProductFormModal />} />
                            <Route path='restaurants/:restaurantId/products/:productId' element={<ProductFormModal />} />
